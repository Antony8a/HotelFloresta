...
namespace Hotel.ClientApp.Service
{
    ...
    public class JwtService
    {
        ...
        public UsersInputModel GenerateToken(Users userLogIn)
        {
            // return null if user not found
            if (userLogIn == null) return null;
            var userResponse = new UsersInputModel() { Identificacion = userLogIn.Identificacion, TipoUsuario = userLogIn.TipoUsuario, Usuario = userLogIn.Usuario };
